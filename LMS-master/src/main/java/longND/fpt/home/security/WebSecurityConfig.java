...
//				.requestMatchers("/api/auth/signin", "/api/auth/signup", "/api/auth/logout", "/api/auth/change-password", "/api/auth/forgot-password")
				.permitAll().requestMatchers("/api/cart_item/**").permitAll().requestMatchers("/api/cart/**")
				.permitAll().requestMatchers("/api/search/**").permitAll().requestMatchers("/api/publisher/**")
				.permitAll().requestMatchers("/api/author/**").permitAll().requestMatchers("/api/department/**")
				.permitAll().requestMatchers("/api/admin/**").permitAll().requestMatchers("/api/book/**").permitAll()
